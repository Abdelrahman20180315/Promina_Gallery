...
class AlbumController extends Controller
{
    ...
    {
        $albumMedia = $album->getMedia();
        if($albumMedia){

           return view('albums.relatedwithdelete',compact('album'));
    ...
    public function moveallpictures(Album $album)
    {
        
        $allalbums = Album::all();
        return view('albums.moveallpictures',compact('album','allalbums'));

    }
    public function movetoselectedalbum(Album $album,Request $request)
    {
        $mediaItem = $album->getMedia()->first();
        $id = $request->choosealbum;
        $selectedalbum = Album::find($id);
        $mediaItem->move($selectedalbum);
        return redirect()->back();
    }
}
